...
public class MobileEmitter extends Emitter {
	...
	public MobileEmitter(double exitVelocity, double velocityVar, double firingAngle, 
			double variation, int numToLaunch, Particle launchType, Particle mobile) throws EmitterException {
		super(mobile.getPosition(), mobile.getCreationTime(), mobile.getLifetime(), exitVelocity, velocityVar, firingAngle, variation,
				numToLaunch, launchType);
		// Do not clone this one!
		followMe = mobile;
	} // end Constructor
